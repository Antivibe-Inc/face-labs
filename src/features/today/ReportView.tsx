...
export function ReportView({ result, image, onRetake, onSaveNote }: ReportViewProps) {
    ...
    return (
        <div className="animate-fade-in space-y-6">
            ...
            {/* Header Section */}
            <div className="flex items-center gap-4 bg-card-bg p-4 rounded-2xl shadow-soft border border-border-soft">
                <img
                    src={image}
                    alt="Face"
                    className="w-16 h-16 rounded-2xl object-cover border border-border-soft"
                />
                <div>
            ...
            {/* 1. Emotion Snapshot */}
            <section className="bg-card-bg p-5 rounded-2xl shadow-soft border border-border-soft">
            ...
            <section className="bg-card-bg p-5 rounded-2xl shadow-soft border border-border-soft">
                ...
                <p className="italic text-text-subtle mb-6 text-sm border-l-2 border-border-soft pl-3">
            ...
            <section className="bg-card-bg p-5 rounded-2xl shadow-soft border border-border-soft">
                ...
                <textarea
                    className="w-full text-sm text-text-main p-3 rounded-2xl border border-border-soft bg-white focus:outline-none focus:ring-1 focus:ring-primary/50 resize-none"
                    rows={3}
...
function ScoreCard({ label, value }: { label: string; value: number }) {
    ...
    return (
        <div className="bg-bg-soft p-3 rounded-2xl flex flex-col items-start border border-border-soft/50">
