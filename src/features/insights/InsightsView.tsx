...
export function InsightsView({ onNavigateToTimeline }: InsightsViewProps) {
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50">
            {/* Header (Fixed) */}
            <div className="pt-4 pb-2 px-6 flex flex-col items-center text-center shrink-0 z-10 bg-gray-50">
            ...
            {/* Scrollable Content */}
            <div className="flex-1 overflow-y-auto no-scrollbar p-4 pb-24 space-y-4 animate-fade-in">
                {/* A. Weekly Overview */}
